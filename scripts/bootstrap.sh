...
# packages to install
####################
package_list="vim virt-install libvirt libguestfs-tools libguestfs git asciidoc rpm-build python2-devel python-pip python-devel sshpass python-httplib2 python-paramiko python-keyczar tigervnc-server pexpect"
####################
...
# download git repo 
################################
#su - $user -c 'git config --global user.name "HORN,JASON"'
#su - $user -c 'git config --global user.email "jason.horn@oracle.com" '
#cp /vagrant/gitconfig /home/$user/.gitconfig; chown jhorn.vagrant /home/$user/.gitconfig
#su - $user -c 'mkdir  -p workdir/pv/testbeds/'
#
