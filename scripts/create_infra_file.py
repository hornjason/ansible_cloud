...
def _print_vlans(infra_file, lab_specifics_data):
  ...
  infra_file.write(x4sp + "private_untagged:" + "\n")
  infra_file.write(x6sp + "id: 1" + "\n")
  ...
  vlan_name = ["ext_management_vlan", "ilom_vlan", "openstack_provider_vlan"]
  net_element = ["vlan_id", "network", "netmask", "broadcast", "host_min", "host_max", "gateway", "ntp_server", "name_server", "defined"]
  for v in vlan_name:
...
def _print_dhcp_subnets(infra_file):
  infra_file.write(x2sp + "dhcp_subnets:" + "\n")
  infra_file.write(x4sp + "info:" + "\n")
  infra_file.write(x6sp + "base: 172.31.0.0" + "\n")
  infra_file.write(x6sp + "netmask: 255.255.0.0" + "\n")
  infra_file.write(x6sp + "range_start: 172.31.0.110" + "\n")
  infra_file.write(x6sp + "range_end: 172.31.254.119" + "\n")
...
lab_specifics_file_name = "group_vars/lab_specifics.yml"
infra_file_name = "/root/loop/group_vars/all"               # {{  role_path }}/var/main.yml
hosts_file_name = "/tmp/hosts"                    # {{ local_repo }}/hosts
...
_print_dhcp_subnets(infra_file)
