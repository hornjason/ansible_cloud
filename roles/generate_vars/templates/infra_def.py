...
lab_specifics_file_name = "{{ playbook_dir }}/group_vars/lab_specifics.yml"
infra_file_name = "{{ playbook_dir }}/roles/generate_vars/vars/main.yml"
hosts_file_name = "{{ local_repo }}/hosts"
